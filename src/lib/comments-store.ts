...
export function ensureSeedData(novelId: string) {
  ...
  const seedComments: Comment[] = [
    ...
    },
    {
      id: "seed-11",
      novelId,
      author: "محمد من القاهرة",
      content: "الرواية ممتازة جداً بجد! أنا من مصر وقريت روايات كتير بس دي حاجة تانية خالص. الأسلوب الأدبي راقي والأحداث مشوقة. في انتظار الفصول القادمة وبالتوفيق للكاتب. تحياتي من مصر 🇪🇬",
      createdAt: Date.now() - 1000 * 60 * 60 * 5,
      likes: ["قارئ مجهول", "عاشق الروايات", "فارس الكلمة", "ليلى"],
    },
    {
      id: "seed-12",
      novelId,
      author: "نور من الإسكندرية",
      content: "إيه الجمال ده! الرواية دي خطفتني من أول صفحة. بيكا عامل شغل محترم أوي والوصف رهيب. بجد حاجة تشرف الأدب العربي المعاصر. مستنية الباقي بفارغ الصبر 😍",
      createdAt: Date.now() - 1000 * 60 * 60 * 3,
      likes: ["محمد من القاهرة", "زينب", "محب القراءة"],
    },
    {
      id: "seed-13",
      novelId,
      author: "كريم السوهاجي",
      content: "يا سلااام على الإبداع! قريت الفصل الأول والثاني في قعدة واحدة مقدرتش أقوم. الأحداث مش مملة خالص وفيها تشويق طول الوقت. ربنا يوفقك يا بيكا ونستنى منك أعمال أكتر 🔥",
      createdAt: Date.now() - 1000 * 60 * 60 * 2,
      likes: ["نور من الإسكندرية", "عاشق الروايات", "سمير من البليدة"],
    },
    {
      id: "seed-14",
      novelId,
      author: "دعاء من المنصورة",
      content: "أول مرة أقرأ رواية جزائرية وبصراحة مبسوطة جداً! اللغة جميلة أوي والشخصيات حسيتها حقيقية. شكراً بيكا على المتعة دي. هابقى أرشح الرواية لكل أصحابي 🥰",
      createdAt: Date.now() - 1000 * 60 * 60 * 1,
      likes: ["محمد من القاهرة", "ليلى", "قارئ مجهول", "الدكتور أحمد"],
    },
    {
      id: "seed-15",
      novelId,
      author: "يوسف من الجيزة",
      content: "تسلم إيدك يا بيكا! الحبكة الدرامية تحفة واللغة سلسة جداً. صحابي كلهم هيقرأوها ان شاء الله. من أفضل ما قرأت السنة دي بلا منازع 💯",
      createdAt: Date.now() - 1000 * 60 * 30,
      likes: ["دعاء من المنصورة", "كريم السوهاجي", "فارس الكلمة"],
    },
  ];
