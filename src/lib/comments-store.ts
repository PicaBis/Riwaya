  ...
  const seedComments: Comment[] = [
    {
      ...
      novelId,
      author: "محب القراءة",
      content: "الفصل الأول حماسي جداً! لم أتوقع هذا التطور في الأحداث.",
    ...
    },
    {
      ...
      novelId,
      author: "فارس الكلمة",
      content: "الوصف في الفصل الثالث يجعلني أشعر وكأنني هناك.obra ادامه Ralph!",
    ...
    },
    {
      ...
      novelId,
      author: "قارئ مجهول",
      content: "هذه الرواية تستحق أكثر من 5 نجوم. شكراً للأستاذ بيكا.",
