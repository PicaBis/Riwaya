        ...
        <div className="space-y-3">
          ...
          >
           ...
           >
             ...
             <div>
               <p className={`text-sm font-medium text-gray-900 dark:text-gray-100 ${fontClass}`}>{t("contact.whatsapp", lang)}</p>
               <p className="text-xs text-gray-500 font-sans">{AUTHOR.whatsappNumber}</p>
             </div>
           </a>
